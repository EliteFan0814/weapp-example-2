...
Page({
  ...
  getData(type) {
    ...
    request.getOrderListClient(page, 10, status).then((res) => {
  ...
  openOrderDetail(e) {
    wx.navigateTo({
      url: `/pages/clientOrderDetails/clientOrderDetails?userType=${this.data.userType}&id=${e.currentTarget.dataset.id}`
    })
  },
  getPhone() {
